...
import { getCompanies, createCompany, updateCompany } from "@/lib/api/companies"
...
export default function ExecutiveCompaniesPage() {
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Manage recruiting companies</p>
        </div>
